            ...
            <v-row align="center" justify="center" class="fill-height">
                <v-col cols="12" sm="12" md="7" class="mx-auto text-center ts--d text-sm-left text-xs-center">
                    ...
                    <p class="hero__section--p">
                        ...
                        korisnicima, firma Corto je
                        <span class="cta__span--1">lider u oblasti dirstibucije vode</span>
                        pomoću water cooler aparata u Bosni i Hercegovini.
                    </p>
                    <v-btn class="ma-2 ml-sm-0 bt--1" tile nuxt to="/distribucija-vode">Ponuda za vodu</v-btn>
                    <v-btn class="ma-2 bt--2" tile outlined nuxt to="/distribucija-kafe">Ponuda za kafu</v-btn>
                </v-col>
                <v-col sm="5"></v-col>
            </v-row>
        </v-container>
